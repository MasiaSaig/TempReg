...
extern int32_t sumTemperatureError;   //!< Sum of temperature errors, used to calculate integral in PID.
extern int16_t setTemperature;				//!< Temperature set by user, which regulator should aim to achive.
extern int16_t temperatureError;      //!< Temperature error, between setTemperature and last read temperature.
extern uint16_t heaterPower;          //!< Power generated by heater, based on last read temperature, its error and electrical circut parameters.
